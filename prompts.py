...
you must convince the writer to extend the text a bit more'''
...
You need incorporate the storyline that you have just writen down to outline what is going to happen in each of the chapter. The novel will be divided into 15 chapter, each chapter will be around 1000 words
''' 
